...
export default function ColorPicker({
  ...
  const hsvToRgb = React.useCallback(
    (hue: number, saturation: number, value: number): Color3 => {
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(to top, black, rgba(0,0,0,0)), linear-gradient(to right, white, hsl(${Math.round(
                      hsv.h
                    )}, 100%, 50%))`,
                  }}
