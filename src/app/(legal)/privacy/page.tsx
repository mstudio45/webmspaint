    ...
    <main className="flex flex-col items-center justify-center md:px-32 px-5 ml-5 mr-5">
      <div className="py-16">
        ...
        <ul className="list-disc ml-5 mt-2">
          ...
          <li>
            Basic Profile Information: Including username, avatar, and email
            address.
          </li>
          <li>
            OAuth Token: Temporary tokens used for authentication purposes.
          </li>
        </ul>
        <p className="mt-2">
        ...
        <ul className="list-disc ml-5 mt-2">
          <li>
            Account Association: Connecting your purchases to your Discord
            account.
          </li>
          <li>
            Product Delivery: Enabling our Discord bot to deliver your purchased
            product keys.
          </li>
          <li>
            Purchase Verification: Ensuring you don&apos;t accidentally purchase
        ...
        <ul className="list-disc ml-5 mt-2">
          <li>
            Service Providers: Neon (our database provider) stores this data
            securely.
          </li>
          <li>
        ...
        <p>
          ...
          <a
            href="mailto:support@mspaint.cc"
